...
import { getLatestModulePath } from "./util.ts";
import { existsSync } from "https://deno.land/std@0.202.0/fs/mod.ts";
import { runTests } from "./test.ts";
import { copySync } from "https://deno.land/std@0.202.0/fs/copy.ts";
...
const latest = getLatestModulePath();

copySync(`${latest}`, MOD_PATH);
