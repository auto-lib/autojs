...
let auto = (obj,opt) => {
    ...
    let resolve = {}; // map the variable names inside a particular function to a new name (for scoping)
    ...
    const res = {                             // return object
        _: { subs, fn, deps, value, resolve, fatal },  // so we can see from the outside what's going on
